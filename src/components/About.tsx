        ...
        >
          ...
          <div className="space-y-6 text-gray-600 dark:text-gray-400 leading-relaxed">
            ...
            <p>
              ...
              I also design and deploy <span className="text-gray-900 dark:text-white font-medium">Ethereum</span>-based smart contracts using{' '}
              <span className="text-gray-900 dark:text-white font-medium">Solidity</span>, with a strong interest in{' '}
              <span className="text-gray-900 dark:text-white font-medium">onchain systems</span>,{' '}
              <span className="text-gray-900 dark:text-white font-medium">decentralized identity</span>, and scalable blockchain applications.
            </p>
